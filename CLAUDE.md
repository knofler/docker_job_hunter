...
`AI/scripts/rotate_state.sh` keeps the hot tier bounded automatically. When the user references an older session, **grep the archive** instead of re-reading STATE.md from scratch:
